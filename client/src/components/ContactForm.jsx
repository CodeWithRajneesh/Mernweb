  ...
  return (
    <section className="bg-black">
      <div className="grid grid-cols-1  gap-8 px-4 py-4 mx-auto border border-gray-900 md:grid-cols-2  dark:text-gray-800">
        <div
          data-aos="zoom-in-up"
          className="flex flex-col hover:shadow-2xl hover:shadow-pink-600 sm:bg-gray-950 bg-gray-900 gap-4 p-8 shadow-2xl "
        >
        ...
        <form
          ...
          className="p-8 space-y-6 hover:shadow-2xl hover:shadow-pink-600 shadow-2xl sm:bg-gray-950 bg-gray-900"
        >
          <div>
